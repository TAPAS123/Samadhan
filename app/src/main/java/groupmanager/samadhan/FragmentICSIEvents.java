 ...
 */
public class FragmentICSIEvents extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.fragment_icsievents, container, false);
        chkShowAll = (CheckBox) rootView.findViewById(R.id.chkShowAll);
        lvEvent = (ListView) rootView.findViewById(R.id.listViewEvnt);
        txtHeadent=(TextView) rootView.findViewById(R.id.txtevnthead);
        ExpandList = (ExpandableListView) rootView.findViewById(R.id.expandableListViewat);
        ...
        Str_chk = this.getArguments().getString("Eventschk");
...
//        Str_chk =  menuIntent.getStringExtra("Eventschk");
        ...
        ExpandList.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent,View v, int groupPosition, int childPosition,long id) {
                ...
                if(Str_chk.equals("1")){
                    menuIntent= new Intent(getContext(),EventDetailValue.class);
    ...
    private void SetExpandableListData()
    {
        ...
        ExpAdapter = new EventSettingsListAdapter(getContext(),categories, ExpandList);
